 ...
 * Original file: /Users/cavelliott/Downloads/OpenIAB-master/library/src/main/aidl/com/skubit/android/billing/IBillingService.aidl
 */
 ...
 */
public interface IBillingService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.skubit.android.billing.IBillingService
{
private static final java.lang.String DESCRIPTOR = "com.skubit.android.billing.IBillingService";
...
/**
 * Cast an IBinder object into an com.skubit.android.billing.IBillingService interface,
 * generating a proxy if needed.
 */
public static com.skubit.android.billing.IBillingService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.skubit.android.billing.IBillingService))) {
return ((com.skubit.android.billing.IBillingService)iin);
}
return new com.skubit.android.billing.IBillingService.Stub.Proxy(obj);
}
...
boolean _result = this.isAuthenticated(_arg0);
...
private static class Proxy implements com.skubit.android.billing.IBillingService
{
...
@Override public boolean isAuthenticated(boolean startDialog) throws android.os.RemoteException
{
...
_data.writeInt(((startDialog)?(1):(0)));
...
/**
     ...
     */
@Override public android.os.Bundle getPurchases(int apiVersion, java.lang.String packageName, java.lang.String type, java.lang.String paginationToken) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.os.Bundle _result;
...
_data.writeString(packageName);
_data.writeString(type);
_data.writeString(paginationToken);
...
static final int TRANSACTION_isAuthenticated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_isBillingSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_getSkuDetails = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_getBuyIntent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_getPurchases = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_consumePurchase = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
}
public boolean isAuthenticated(boolean startDialog) throws android.os.RemoteException;
/**
     * Checks support for the requested billing API version, package and in-app type.
     * Minimum API version supported by this interface is 3.
     * @param apiVersion the billing version which the app is using
...
/**
     ...
     *                                      user has more owned skus than the current list.
     */
public android.os.Bundle getPurchases(int apiVersion, java.lang.String packageName, java.lang.String type, java.lang.String paginationToken) throws android.os.RemoteException;
/**
     * Consume the last purchase of the given SKU. This will result in this item being removed
     * from all subsequent responses to getPurchases() and allow re-purchase of this item.
     * @param apiVersion billing API version that the app is using
